...
export function Footer() {
  return (
    <footer className="w-full bg-white">
      <div className="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12  bg-slate-600 text-center  py-10">
        <section class="flex justify-center items-center">
          <a
            href="https://www.instagram.com/darsh_12_06/"
        ...
        <section class="flex justify-center items-center">
          <a
            href="https://twitter.com/DarshPatel1206"
        ...
        <section class="flex justify-center items-center">
          <a
            class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-black text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
            href="https://github.com/darsh1206"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <Typography color="blue-gray" className="text-center font-normal bg-slate-900 text-white py-5 text-sm sm:text-lg md:text-lg lg:text-lg">
